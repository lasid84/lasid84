      ...
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(onSearch)} className="w-full space-y-1">
          ...
          >
            ...
            <MaskedInputField id="last_interfaced" lwidth='w-24' width="w-36" height='h-8' value={data?.last_interfaced} options={{ isReadOnly: true, inline: true, textAlign: 'center', type: 'time', fontSize : "xs" }} />
