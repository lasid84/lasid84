                        ...
                        <div className={`flex flex-col w-full h-[400px] ${selectedTab == "NM" ? "" : "hidden"}`}>
                            <div className="overflow-y-auto md:grid md:grid-cols-5">
                                ...
                                <div className={"p-1 col-span-2"}>
                                    ...
                                    <MaskedInputField id="invoice_tot_amt" value={objState.mSelectedDetail?.invoice_tot_amt} options={{ isReadOnly: true, textAlign: 'right', inline: true, type: "number", isAllowDecimal: true, decimalLimit: 2 }} height='h-6' />
                                    <MaskedInputField id="invoice_taxable" value={objState.mSelectedDetail?.invoice_taxable} options={{ isReadOnly: true, textAlign: 'right', inline: true, type: "number",  isAllowDecimal: true, decimalLimit: 2 }} height='h-6' />
                                    ...
                                    <MaskedInputField id="local_tot_amt" value={objState.mSelectedDetail?.local_tot_amt} options={{ isReadOnly: true, textAlign: 'right', inline: true, type: "number", isAllowDecimal: true, decimalLimit: 2 }} height='h-6' />
