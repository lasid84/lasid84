...
const MasterGrid: React.FC<Props> = memo(({ initData }) => {
    ...
    const gridOption: GridOption = {
        colVisible: { col: ["user_id", "user_nm", "permission_id", "bz_plc_code", "emp_no", "ufs_id", "terminal_cd", "dept_cd", "office_cd", "use_yn", "remark", "tel_num", "edi_email", "ufs_pw"], visible: true },
        // checkbox: ["use_yn"],
        gridHeight: "h-full",
