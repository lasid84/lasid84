    ...
    <div className="sticky top-0 z-20 w-full pt-10 space-y-1 bg-white">
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(onSearch)} className="w-full space-y-1">
          ...
          >      
            <MaskedInputField id="bk_id" lwidth='w-24' width="w-36" height='h-8' value={data?.bk_id} options={{ isReadOnly: true, inline: true, textAlign: 'center', }} />
            <MaskedInputField id="create_user" lwidth='w-24' width="w-36" height='h-8' value={data?.create_user} options={{ isReadOnly: true, inline: true, textAlign: 'center', }} />
            {/* <MaskedInputField id="create_date" lwidth='w-24' width="w-36" height='h-8' value={data?.create_date} options={{ isReadOnly: true, inline: true, textAlign: 'center', }} /> */}
             <MaskedInputField id="update_date" lwidth='w-24' width="w-36" height='h-8' value={data?.update_date} options={{ isReadOnly: true, inline: true, textAlign: 'center', }} />
           </PageBKTabContent>
        </form>
      </FormProvider>
    </div>
