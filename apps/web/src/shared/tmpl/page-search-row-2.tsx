      ...
      {/* <div className="flex">
        <div className="w-10/12 rounded-[5px] bg-white border mb-2"> */}
          ...
          <div className="px-4 py-1 w-full space-y-2">
            <div className="w-full flex flex-row md:flex-row md:grid md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 gap-3">
              {children}
            </div>            
            <div
              className="w-full flex flex-row md:flex-row md:grid md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 gap-2">
              {addition && addition}
            </div>
          </div>
          {/*button*/}
