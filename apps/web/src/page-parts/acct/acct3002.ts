...
const codeFind = (searchParam:any) => {
    ...
    , "in_user_id"
    , "in_ipaddr"]
    const invalue = [Param.trans_mode,Param.trans_type,Param.office_cd,Param.invoice_no,Param.fr_date.replace(reg,''),Param.to_date.replace(reg,''),Param.fr_inv_date,Param.to_inv_date,Param.cust_code,
